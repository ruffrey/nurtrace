...
func Test_GrowPathBetween_Integrity(t *testing.T) {
	...
	t.Skip("does not add synapses when there are already enough", func(t *testing.T) {

	})
	t.Skip("adds valid synapses and all cells have working connections after growth", func(t *testing.T) {
